...
> = {
  'prod-strawberries-1': {
    ...
    descriptionText:
      'Grown in the nutrient-rich volcanic soil of our partner organic farms, these Heritage Strawberries are allowed to ripen fully on the vine, ensuring an unmatched sweetness and deep aromatic profile.',
    calories: '32 kcal',
    vitaminC: '98% DV',
    sugars: '4.9g',
    fiber: '2.0g',
  ...
  'sim-1': {
    ...
    descriptionText:
      'Hand-picked from certified organic wild berry patches. Bursting with natural antioxidants, deep purple pigment, and a tart-sweet flavor profile perfect for breakfasts, smoothies, and snacking.',
    calories: '57 kcal',
    vitaminC: '24% DV',
    sugars: '9.9g',
    fiber: '2.4g',
  ...
  'sim-2': {
    ...
    descriptionText:
      'Delicate, fragrant red raspberries grown in coastal fog belts. Soft, velvety texture with a fragrant floral aroma and balanced acidity.',
    calories: '52 kcal',
    vitaminC: '44% DV',
    sugars: '4.4g',
    fiber: '6.5g',
  ...
  'sim-3': {
    ...
    descriptionText:
      'Large, glossy black berries harvested at peak sweetness. Packed with dietary fiber, Vitamin K, and natural phytonutrients.',
    calories: '43 kcal',
    vitaminC: '35% DV',
    sugars: '4.9g',
    fiber: '5.3g',
  ...
  'sim-4': {
    ...
    descriptionText:
      'Sweet, juicy Gala apples with a thin red-striped skin and dense, crunchy texture. Naturally rich in pectin and Vitamin C.',
    calories: '52 kcal',
    vitaminC: '14% DV',
    sugars: '10.3g',
    fiber: '2.4g',
...
const ProductDetailsContent = () => {
  ...
  const product = matched ?? {
    ...
    reviewCount: Number(
      data?.product?.reviewCount ?? SAMPLE_PRODUCT.reviewCount
    ),
    ...
    gallery:
      data?.gallery && data.gallery.length > 0 ? data.gallery : SAMPLE_GALLERY,
    descriptionTitle: 'Sun-Ripened Heritage Berries',
    descriptionText:
      'Grown in the nutrient-rich volcanic soil of our partner organic farms, these Heritage Strawberries are allowed to ripen fully on the vine, ensuring an unmatched sweetness and deep aromatic profile.',
    calories: '32 kcal',
  ...
  const gallery =
    ...
    (data?.gallery && data.gallery.length > 0 ? data.gallery : SAMPLE_GALLERY);
  const similar =
    data?.similar && data.similar.length > 0 ? data.similar : SIMILAR_FRUITS;
      ...
      <main className="mx-auto max-w-7xl space-y-8 px-4 pt-24 pb-16 sm:px-6 md:px-8">
        ...
        <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-[1.2fr_1fr]">
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            <div className="order-2 flex gap-3 overflow-x-auto sm:order-1 sm:flex-col sm:overflow-visible">
              {gallery.slice(0, 4).map((imgUrl, idx) => (
                <button
                  key={idx}
                  className={`h-18 w-18 shrink-0 cursor-pointer overflow-hidden rounded-2xl border-2 bg-white p-1 transition-all sm:h-20 sm:w-20 ${
                    activeImage === idx
                      ? 'border-[#006b2c] shadow-xs'
            ...
            {/* Main Showcase Image */}
            <div className="relative order-1 flex min-h-[380px] flex-1 items-center justify-center rounded-[28px] border border-[#e2ebdE] bg-white p-6 shadow-xs sm:order-2 sm:min-h-[460px]">
              {/* Badges */}
              ...
              <img
                alt={product.name}
                className="max-h-[380px] w-full object-contain mix-blend-multiply transition-all duration-300"
                src={mainImage}
              />

              {/* Zoom Glass Button */}
              <button
                className="absolute right-5 bottom-5 flex h-10 w-10 items-center justify-center rounded-full border border-[#e2ebdE] bg-white text-[#006b2c] shadow-sm transition-all hover:bg-[#eff6ea]"
                type="button"
              >
          ...
          <div className="space-y-6 rounded-[28px] border border-[#e2ebdE] bg-white p-6 shadow-xs sm:p-8">
            <div>
              <h1 className="text-2xl font-black tracking-tight text-[#171d16] sm:text-3xl">
                {product.name}
              </h1>
              <p className="mt-1 text-xs font-extrabold text-[#8b9888]">
                By{' '}
                <a className="text-[#006b2c] hover:underline" href="#farm">
                  Nature's Harvest Farms
                </a>
              </p>
            </div>
            ...
            <div className="space-y-1">
              <div className="flex items-baseline gap-3">
                <span className="text-3xl font-black text-[#171d16] sm:text-4xl">
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2 rounded-2xl border border-[#bdcaba]/60 bg-[#f8fbf5] px-3 py-2 shadow-xs">
                  <button
                    ...
                    className="flex h-7 w-7 cursor-pointer items-center justify-center rounded-xl bg-white text-[#171d16] shadow-xs transition-all hover:bg-[#eff6ea]"
                    onClick={() => setQuantity(Math.max(1, quantity - 1))}
                    type="button"
                  >
                    <Minus className="h-3.5 w-3.5 stroke-[3]" />
                  </button>
                  <span className="w-6 text-center text-sm font-black text-[#171d16]">
                    {quantity}
                  </span>
                  <button
                ...
                <Button
                  ...
                  onClick={() =>
                    void addToCart({ productId: product.productId, quantity })
                  }
                  type="button"
                >
                ...
                <button
                  className="flex h-12 w-12 cursor-pointer items-center justify-center rounded-2xl border border-[#bdcaba]/60 bg-white text-[#8b9888] shadow-xs transition-all hover:border-rose-300 hover:text-rose-600"
                  type="button"
                >
              ...
              {/* Buy Now Button */}
              <Button
                className="h-12 w-full cursor-pointer rounded-2xl bg-[#171d16] text-xs font-extrabold text-white shadow-xs transition-all hover:bg-black"
                type="button"
              >
                Buy Now
              </Button>
            ...
            <div className="space-y-3 border-t border-[#e2ebdE] pt-5">
              ...
              <div className="flex items-center gap-3 text-xs font-extrabold text-[#3e4a3d]">
                ...
                <div>
                  <span className="block text-[#171d16]">
                    Freshness Guaranteed
                  </span>
                  <span className="text-[11px] font-semibold text-[#8b9888]">
                    100% refund if not satisfied on delivery
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 items-start gap-8 pt-4 lg:grid-cols-[1.5fr_1fr]">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3 pt-4">
              <h3 className="text-sm font-black text-[#171d16]">
                Frequently bought together
              </h3>
              <div className="flex flex-col items-center justify-between gap-5 rounded-[24px] border border-[#e2ebdE] bg-white p-5 shadow-xs sm:flex-row">
                <div className="flex items-center gap-3">
                  <img
                    alt={product.name}
                    className="h-16 w-16 rounded-2xl border border-[#e2ebdE] object-contain p-1 mix-blend-multiply"
                    src={mainImage}
                  />
                  ...
                  <img
                    alt="Greek Yogurt"
                    className="h-16 w-16 rounded-2xl border border-[#e2ebdE] object-contain p-1 mix-blend-multiply"
                    src="https://images.unsplash.com/photo-1488477181946-6428a0291777?w=120"
                  />
                </div>
                ...
                <div className="flex items-center gap-4 text-center sm:text-right">
                  <div>
                    ...
                    <span className="ml-1 text-xs font-bold text-[#8b9888] line-through">
                      $19.50
                    </span>
                  </div>
                  <Button
                    className="h-10 cursor-pointer rounded-xl bg-[#006b2c] px-4 text-xs font-black text-white transition-all hover:bg-[#005422]"
                    type="button"
                  >
                    Add 2 Items to Cart
                  </Button>
          ...
          <div className="space-y-4 rounded-[24px] border border-[#bdcaba]/30 bg-[#eff6ea] p-6">
            <h3 className="text-xs font-black tracking-wider text-[#005320] uppercase">
            ...
            <p className="border-t border-[#bdcaba]/30 pt-2 text-[10px] leading-tight font-semibold text-[#8b9888]">
        ...
        <div className="space-y-4 pt-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                className="flex h-8 w-8 items-center justify-center rounded-full border border-[#bdcaba]/60 bg-white text-[#171d16] transition-all hover:bg-[#eff6ea]"
                type="button"
              >
