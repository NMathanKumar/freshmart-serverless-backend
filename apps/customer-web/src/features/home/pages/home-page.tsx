  ...
  return (
    <div className="home-page min-h-screen bg-[#f4fcf0] text-[#171d16] w-full">
      ...
      <main className="mx-auto max-w-7xl space-y-10 px-4 md:px-8 pb-12 pt-20">
        ...
        <section className="relative space-y-6" aria-labelledby="trending-heading"><div className="pr-28"><h2 className="text-2xl md:text-[32px] font-bold leading-10 tracking-[-0.01em]" id="trending-heading">Trending Now</h2><p className="text-base text-[#3e4a3d]">Most popular picks this week</p></div><ProductCarousel error={hasError} loading={query.isLoading} products={trending} retry={retry} /></section>
