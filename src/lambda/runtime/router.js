...
const inventoryService = require('../../../services/inventory-service/src/services/inventory.service');
const cartService = require('../../../services/cart-service/src/services/cart.service');
const orderService = require('../../../services/order-service/src/services/order.service');
const paymentService = require('../../../services/payment-service/src/services/payment.service');
const notificationService = require('../../../services/notification-service/src/services/notification.service');
const analyticsService = require('../../../services/analytics-service/src/services/analytics.service');
const adminService = require('../../../services/admin-service/src/services/admin.service');
