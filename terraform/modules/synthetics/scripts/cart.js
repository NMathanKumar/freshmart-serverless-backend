...
const checkEndpoint = (hostname, path, method) => new Promise((resolve, reject) => {
    const req = https.request({ hostname, path, method: method || 'GET', port: 443, timeout: 10000 }, (res) => {
        res.resume();
...
exports.handler = async () => {
    ...
    await checkEndpoint(url.hostname, `${base}/cart`);
};
